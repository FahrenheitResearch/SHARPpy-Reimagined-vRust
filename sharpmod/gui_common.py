...
#: Decoder-backed sounding formats offered by the local-file picker.  SPC files
#: are commonly named after stations (for example ``KOUN.OAX``), so advertise
#: both the format and station-name extensions on case-sensitive desktops.
