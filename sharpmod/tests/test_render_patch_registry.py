...
def test_renderer_declares_one_named_spec_per_patch_installer():
    ...
    assert names.index("skewt.surface-padding") < names.index(
        "skewt.surface-label-mask")
    assert names.index("skewt.surface-label-mask") < names.index(
        "skewt.surface-label-overlay")
