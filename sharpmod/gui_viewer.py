...
def compose_interactive(config, prof_col, controller, *, stn_id=None,
    ...
    # ``defer_show`` performs the vendored constructor's required show/layout
    # cycle with WA_DontShowOnScreen, then returns the realized window hidden.
    # Geometry is therefore ready for the sizing work below without exposing a
    # blank native surface to the Windows compositor.
